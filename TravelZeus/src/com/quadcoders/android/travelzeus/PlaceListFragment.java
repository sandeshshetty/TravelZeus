...
public class PlaceListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.d("tag", s + " after settitle");
		mPlaces = PlacesLab.get(getActivity()).getPlaceList(s);
		Log.d("tag", "mplaces size " + mPlaces.size());
		ArrayAdapter<Places> adapter = new ArrayAdapter<Places>(getActivity(), android.R.layout.simple_list_item_1, android.R.id.text1, mPlaces);
