...
public class Places {
	...
	public class Comment {
		...
		public static final String JSON_USER_NAME = "nameUser";
		public static final String JSON_USER_COMMENTS = "userComments";
	...
	public JSONObject toJSON() throws JSONException {
		...
		for(Comment c: mComments) {
			json.put(Comment.JSON_USER_NAME, c.getPersonName());
			json.put(Comment.JSON_USER_COMMENTS, c.getComment());
		}
		return json;
		}
